...
This module closes the save/load contract around actor/critic checkpoints
without changing RL math. Under vectorized training, the actual completed
episode count can differ from the nominal ``Config.train_episodes`` target,
so downstream evaluation should prefer manifest metadata over hard-coded tags.
"""
