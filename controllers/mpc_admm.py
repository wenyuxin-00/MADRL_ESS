...
from envs.grid_env import project_action_to_soc
...
def build_admm_mpc_coordination_cache(cfg: Cfg, env, *, horizon_steps: int) -> AdmmMpcCoordinationCache:
...
def run_admm_mpc_step(
    ...
    *,
    ...
    iteration_budget = int(max_iters_first_step) if int(env.cur_step) == 0 else int(max_iters)
