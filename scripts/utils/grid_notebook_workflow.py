...
from predictors.mainline_forecast import ensure_mainline_forecast_ready,resolve_mainline_forecast_controls
...
def apply_notebook_experiment_settings(cfg,*,prediction_mode:str,test_start_date:str|int|None,test_end_date:str|int|None,agent_profiles:list[str]|None=None,agent_bus_ids:list[int]|None=None,load_scale:float|list[float]|None=None,pv_scale:float|list[float]|None=None,future_horizon:int|None=None,battery_controls:Mapping[str,object]|None=None,forecast_controls:Mapping[str,object]|None=None,train_year:int|None=None,test_year:int|None=None)->dict[str,object]:
	...
	cfg.data.test_start_date,cfg.data.test_end_date=normalize_date_input(test_start_date),normalize_date_input(test_end_date);resolved_load_scale,resolved_pv_scale=cfg.data.resolved_load_scale(cfg.env.num_agents)if load_scale is None else load_scale,cfg.data.resolved_pv_scale(cfg.env.num_agents)if pv_scale is None else pv_scale;cfg.data.load_scale=normalize_agent_scale(resolved_load_scale,n_agents=cfg.env.num_agents,name='load_scale');cfg.data.pv_scale=normalize_agent_scale(resolved_pv_scale,n_agents=cfg.env.num_agents,name='pv_scale');resolved_battery_controls=resolve_battery_controls(cfg,battery_controls)
