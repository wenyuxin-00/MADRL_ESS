...
def apply_runtime_profile(cfg: ExperimentConfig, runtime_mode: str) -> ExperimentConfig:
    ...
    for attr in ('allow_tf32', 'cudnn_benchmark', 'cudnn_deterministic', 'use_deterministic_algorithms', 'pin_memory', 'non_blocking_transfers', 'enable_amp', 'enable_compile'):
