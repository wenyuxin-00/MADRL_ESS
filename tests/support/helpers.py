...
def make_smoke_config(tmp_path: str | Path, algorithm: str = "MADDPG") -> ExperimentConfig:
    ...
    cfg.data.test_start_date = None
    cfg.data.test_end_date = None
    ...
    cfg.train.learning_starts_transitions = 0
    cfg.train.actor_learning_starts_transitions = 0
    cfg.train.n_step_return = 1
    cfg.train.feasible_random_exploration_start = 0.0
    cfg.train.feasible_random_exploration_end = 0.0
    cfg.train.feasible_random_exploration_decay_steps = 1
